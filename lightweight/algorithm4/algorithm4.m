function [centers,sampNum,z_prime,time] = algorithm4(data,k,z,varargin)
...
p.addParameter('z_prime',defaultz,...
...
for i = 1:Times
    ...
    [centers_t,~] = kmeans_mm(S,k,z_prime);
    %
    rpt_cost(i) = Sum_sqdist(centers_t,ValdnSet,round(z*ValdnRatio));
